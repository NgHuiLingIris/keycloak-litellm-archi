            ...
            if prisma_client is not None:
                ...
                if (
                    ...
                    raise ProxyException(
                        message=f"You must be a LiteLLM Enterprise user to use SSO for more than {free_sso_user_limit} users. If you have a license please set `LITELLM_LICENSE` in your env. If you want to obtain a license meet with us here: https://enterprise.litellm.ai/demo You are seeing this error message because You set one of `MICROSOFT_CLIENT_ID`, `GOOGLE_CLIENT_ID`, or `GENERIC_CLIENT_ID` in your env. Please unset this",
